...
! function(global, factory) {
    if ("function" == typeof define && define.amd) define("/Site", ["exports", "jquery", "Config", "Base", "Menubar", "GridMenu", "Sidebar", "PageAside"], factory);
    else if ("undefined" != typeof exports) factory(exports, require("jquery"), require("Config"), require("Base"), require("Menubar"), require("GridMenu"), require("Sidebar"), require("PageAside"));
    else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.jQuery, global.Config, global.Base, global.SectionMenubar, global.SectionGridMenu, global.SectionSidebar, global.SectionPageAside), global.Site = mod.exports
    }
    ...
    var _jquery2 = babelHelpers.interopRequireDefault(_jquery),
        ...
        _GridMenu2 = babelHelpers.interopRequireDefault(_GridMenu),
        ...
        Site = function(_Base) {
            ...
            return babelHelpers.inherits(Site, _Base), babelHelpers.createClass(Site, [{
                ...
                value: function() {
                    var _this2 = this;
                    this.startLoading(), this.initializePluginAPIs(), this.initializePlugins(), this.initComponents(), setTimeout(function() {
                ...
                key: "process",
                value: function() {
                    this.polyfillIEWidth(), this.initBootstrap(), this.setupMenubar(), this.setupGridMenu(), this.setupFullScreen(), this.setupMegaNavbar(), this.setupTour(), this.setupNavbarCollpase(), this.$el.on("click", ".dropdown-menu-media", function(e) {
                        e.stopPropagation()
                    })
                }
            }, {
                ...
                value: function() {
                    ...
                    this.menubar.change(defaultState.menubarType), this.gridmenu.toggle(defaultState.gridmenu)
                }
            }, {
                key: "getDefaultState",
                value: function() {
                ...
                value: function() {
                    ...
                    $DOC.on("click", '[data-toggle="gridmenu"]', function() {
                        var $this = (0, _jquery2.default)(this),
                            isOpened = self.gridmenu.isOpened;
                        isOpened ? $this.addClass("active").attr("aria-expanded", !0) : $this.removeClass("active").attr("aria-expanded", !1), self.gridmenu.toggle(!isOpened)
                    })
                }
            }, {
                key: "setupMegaNavbar",
